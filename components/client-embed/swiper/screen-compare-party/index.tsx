          ...
          <div className="lg:w-2/3">
            <div className="grid gap-4 mt-6 col-1">
              {questions.map((question) => {
                ...
                return (
                  <div
                    className="relative flex flex-wrap items-start rounded-lg bg-gradient-to-b from-white to-brand-light-blue p-4 md:p-6"
                    key={question.id}
                  >
                    <div className={styles.video}>
                      <div className="relative h-[60px] md:h-[80px] w-[60px] md:w-full rounded-full lg:h-[120px] md:rounded overflow-hidden shadow-lg pointer-events-none">
                        ...
                        <button
                          ...
                          className={cn(
                            'pointer-events-auto absolute left-1/2 top-1/2 -mt-4 -ml-4 flex h-8 w-8 items-center justify-center rounded-full pl-1 text-white focus-default lg:-mt-6 lg:-ml-6 lg:h-12 lg:w-12',
                        ...
                        {partyAnswer?.reason ? (
                          <>
                            <button
                              ...
                              className="flex items-center text-sm font-medium text-brand-dark-blue underline text-underline-offset-2 hover:text-brand-primary focus-default lg:text-base"
                            >
                            ...
                            <AnimatePresence>
                              {reason === question.id && (
                                ...
                                >
                                  <div className="prose-sm pt-2 lg:prose">
                                    {partyAnswer?.reason}
                                  </div>
                                </motion.div>
                              )}
                          ...
                          <div className="flex items-center font-medium text-brand-primary">
                            <IconInfo className="mr-2 h-5 text-brand-dark-blue" />
