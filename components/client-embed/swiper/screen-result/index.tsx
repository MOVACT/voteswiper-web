...
import PaypalDonationForm from 'components/client-embed/paypal-donation-form';
            ...
            result.scores.map((score, index) => {
              ...
              return (
                <div key={score.id}>
                  <button
                    className={cn(
                      'relative block h-12 w-full overflow-hidden rounded focus-default',
                      clientEmbedStyles.resultBarTrack
                    )}
                    onClick={() => {
                  ...
                  >
                    <motion.div
                      className={cn(
                        'h-12 rounded',
                        clientEmbedStyles.resultBarFill
                      )}
                      initial={{
                        width: 0,
                      }}
                    ...
                    <div
                      className={cn(
                        'absolute inset-0 flex items-center justify-between px-4 text-sm font-medium lg:text-base',
                        clientEmbedStyles.resultBarLabel
                      )}
                    >
