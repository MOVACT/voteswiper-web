...
const ClientEmbedHeader: React.FC = () => {
  ...
  return (
    <>
      <header
        className={cn(
          styles.header,
          'fixed z-50 w-screen flex items-center transition-all print:hidden border-b border-black border-opacity-10 lg:border-0 bg-[#1b0054]',
          scrolled
            ? 'h-16 duration-500'
            : 'h-16 lg:h-32 lg:pt-12 duration-200 lg:bg-transparent',
...
export default ClientEmbedHeader;
